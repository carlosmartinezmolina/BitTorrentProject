...
class A:
    ...
    async def tcp_echo_client(self, loop):
        ...
        ipList=[]
        ipList.append(('169.254.31.129',8888))
        m = 'C:\\Users\\Eziel\\Desktop\\peer2\\dir\\TPMatematica.pdf'
        ...
        if ipList[0] != 'exit':
            ...
            path = 'C:\\Users\\Eziel\\Desktop\\dir\\TPMatematica.pdf'
            f = open(path,'ab+')
